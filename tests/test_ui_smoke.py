...
@pytest.mark.skip("UI tests disabled due to slot context issues in test environment")
async def test_all_pages_smoke_fast():
    """Fast smoke test - skipped due to slot context issues"""
    pass
